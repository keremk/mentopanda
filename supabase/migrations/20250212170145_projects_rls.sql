...
create policy "Users can manage projects with permission" on projects for all to authenticated using (authorize('project.manage')) with check (authorize('project.manage'));