-- Update deep_copy_training function to handle origin_id and forked_at columns
...
DECLARE
  ...
  result JSONB;
BEGIN
  -- 1. Copy training (with is_public=false, origin tracking)
  INSERT INTO trainings (title, tagline, description, image_url, preview_url, project_id, created_by, is_public, fork_count, origin_id, forked_at)
  SELECT title, tagline, description, image_url, preview_url, target_project_id, target_user_id, false, 0, source_training_id, CURRENT_TIMESTAMP
