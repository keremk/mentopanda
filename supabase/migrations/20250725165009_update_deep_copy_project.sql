-- Update deep_copy_project function to handle new skills and emotion columns
...
BEGIN
    ...
    -- Copy module_characters relationships using the mappings (including new skills and emotion columns)
    INSERT INTO modules_characters (
        module_id, character_id, ordinal, prompt, skills, emotion
    )
    SELECT 
        mm.new_id,
