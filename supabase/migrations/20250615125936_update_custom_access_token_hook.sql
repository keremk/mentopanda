-- Revert to EXACT original working hook to test
...
DECLARE
    ...
    user_onboarding public.onboarding_status;
...
BEGIN
    ...
    claims := jsonb_set(claims, '{onboarding}', to_jsonb(COALESCE(user_onboarding::text, 'not_started')));
